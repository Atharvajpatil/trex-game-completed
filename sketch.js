...
function setup() {
  ...
  trex = createSprite(windowWidth/16+50,windowHeight-20,20,50);
  
  trex.addAnimation("running", trex_running);
  trex.addAnimation("collided", trex_collided);
  trex.scale = 0.5;
  
  ground = createSprite(windowWidth/2-200,windowHeight-20,windowWidth/2+400,20);
  ...
  invisibleGround = createSprite(windowWidth/6,windowHeight-10,400,10);
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    var ran = Math.round(random(windowHeight-120,windowHeight-200));
    var cloud = createSprite(windowWidth,ran,40,10);
